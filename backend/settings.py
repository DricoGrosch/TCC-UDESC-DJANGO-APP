...
SECRET_KEY = 'django-insecure-*lj_*^%=6+m9*oz+kexew4o99++&d%vyjd&9bbosmj@ww^br+y'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "deployment", "backend", "collected_static")
